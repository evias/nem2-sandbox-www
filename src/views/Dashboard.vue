                ...
                <b-col sm="6">
                  <Callout variant="info">
                    ...
                    <div class="chart-wrapper" :style="{ top: '-10px'}">
                      <callout-chart chartId="callout-chart-01" :data="[35, 23, 56, 22, 97, 23, 64]" variant="info" width="80" height="30" />
                    </div>
                  </Callout>
                </b-col>
                <b-col sm="6">
                  <Callout variant="danger">
                    ...
                    <div class="chart-wrapper" :style="{ top: '-10px'}">
                      <callout-chart chartId="callout-chart-02" :data="[65, 59, 84, 84, 51, 55, 40]" variant="danger" width="80" height="30" />
                    </div>
                  </Callout>
                </b-col>
              </b-row>
              ...
              <b-row>
                <b-col sm="6">
                  <Callout variant="warning">
                    ...
                    <div class="chart-wrapper" :style="{ top: '-10px'}">
                      <callout-chart chartId="callout-chart-03" :data="[35, 23, 56, 22, 97, 23, 64]" variant="#f8cb00" width="80" height="30"/>
                    </div>
                  </Callout>
                </b-col>
                <b-col sm="6">
